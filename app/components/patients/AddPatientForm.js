...
export default function AddPatientForm() {
  ...
  return (
    <div>
      {/* Success message */}
      {success && (
        <div className="mb-6 p-4 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-800 text-primaryColor dark:text-green-300 rounded-md">
      ...
      {/* Form error */}
      {errors.submit && (
        <div className="mb-6 p-4 bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-800 text-red-700 dark:text-red-300 rounded-md">
          <div className="flex items-center">
